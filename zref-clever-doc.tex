...
\opt{label} option and rest at ease.  Also, \pkg{breqn} does not use
...
the use of \pkg{ltcmdhooks} command hooks on \cs{bitwonumcaption},
\cs{bionenumcaption}, \cs{bicaption}, \cs{@memsubcaption}, \cs{@makefntext},
and \cs{@makesidefntext}.
...
The module also sets appropriate \opt{countertype}, \opt{counterresetby} and
