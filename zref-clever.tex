...
to.  It can receive \pkg{zref} properties, as long as they are
declared,\footnote{A neat example of how powerful this is can be found at
  \url{https://tex.stackexchange.com/a/670088}, where support for a reference
  ``suffix'' in Turkish is provided by setting \opt{ref} to a dedicated
  property which includes the suffix according to the reference's value.} but
