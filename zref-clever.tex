...
interface.  And, on top of that, adds some spice of its own.  Alas, there are
some limitations (see \zcref{sec:limitations}), and it may be your cup of tea
or not.  Still, all in all, hopefully \pkg{zref-clever} can make \pkg{zref}
more accessible to the average user, and more interesting to users in general.
