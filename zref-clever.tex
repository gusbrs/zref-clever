...
\begin{table}[htb]
  ...
  \begin{tabular}{l>{\ttfamily}lcccc}
    ...
    options         & abbrev     & $\bullet$ & $\bullet$ &   $\bullet$   &  $\bullet$   \\
    \bottomrule
  \end{tabular}
...
``other'' options.  ``String'' options is not really a strict denomination for
the first category, but this set of options is intended exclusively for
