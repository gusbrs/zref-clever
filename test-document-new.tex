...
\zcref[capitalize=first,abbrev=butfirst,language=main]{cha:chapter-3,fig:figure-3-1,sec:section-1.1,sec:subs-2.1.1.2,cha:chapter-1,sec:section-3.1}

\zcref[capitalize,nameinlink=singleintype]{sec:subs-2.1.1.2}
