...
-- check -c build' for quicker tests, and using the full 'l3build check' only
-- when thorough testing is indeed required.  This excludes 'build-moreruns'
-- from the dev format set, but there's really no need for it to be included.
